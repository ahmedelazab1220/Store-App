...
abstract class Styles {
  ...
  static final textStyle31 = GoogleFonts.almarai(
    color: const Color(0xff626262b2).withOpacity(0.7),
    fontSize: 13,
    fontWeight: FontWeight.w700, // 700
  );

  static final textStyle32 = GoogleFonts.almarai(
    color: Colors.white,
    fontSize: 14,
    fontWeight: FontWeight.w700, // 700
  );

  static final textStyle33 = GoogleFonts.almarai(
    color: const Color(0xff615D5D),
    fontSize: 15,
    fontWeight: FontWeight.w700, // 700
  );

  static final textStyle34 =  GoogleFonts.almarai(
    color: const Color(0xff8E8E8E),
    fontSize: 11,
    fontWeight: FontWeight.w700, // 700
  );

  static final textStyle35 =  GoogleFonts.almarai(
      fontWeight: FontWeight.w700,
      fontSize: 14,
      color: const Color(0xff615D5D),
  );
  ...
  static final textStyle44 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w400,
    fontSize: 13,
    color: const Color(0xff6A6565).withOpacity(0.8),
  );
  static final textStyle46 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w400,
    fontSize: 14,
    color: const Color(0xff615D5D)
  );
  static final textStyle47 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w700,
    fontSize: 20,
    color: const Color(0xff615D5D)
  );
  static final textStyle48 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w700,
    fontSize: 14,
    color: const Color(0xff615D5D)
  );
  static final textStyle49 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w800,
    fontSize: 16,
    color: const Color(0xff736D6D)
  );
  static final textStyle50 =  GoogleFonts.almarai(
    fontWeight: FontWeight.w800,
    fontSize: 16,
    color: const Color(0xff5941AF)
  );
  ...
  static final textStyle52 = GoogleFonts.almarai(
    color: const Color(0xff615D5D),
    fontSize: 15,
    fontWeight: FontWeight.w400, // 700
  );
